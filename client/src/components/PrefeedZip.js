...
class PrefeedZip extends Component {
	constructor() {
		super();
		this.state = {
			isOpen: false
	...
	componentDidMount() {
		...
		if (this.props.match.params.zip_code !== undefined) {
			console.log(this.props.match.params.zip_code);
			localStorage.setItem("zip_code", this.props.match.params.zip_code);
			if (window.innerHeight < 690)
				document.getElementsByClassName("extra-space")[0].style.paddingBottom =
					"20vh";
			else
